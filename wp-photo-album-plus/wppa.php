...
/* WPPA Version */
global $wppa_version; 		$wppa_version = '9.2.06.002';							// WPPA software version
...
/* Start session */
add_action( 'init', 'wppa_begin_session', 100 );
...
add_action( 'init', 'wppa_init_language' );
...
add_action( 'rest_api_init', function() {
	register_rest_route('wp-photo-album-plus', '/endPoint/', array(
		'methods' => 'GET,POST',
		'callback' => 'wppa_ajax_callback',
