...
global $wpdb;
	...
	// Open the thumbframe
	$result .= 	'<div id="thumbnail_frame_'.$xid.'_'.$mocc.'" class="'.$class.'" style="'.$framestyle.'">';
	...
	$result .= '<div class="wppa-tn-img-container" style="height:'.$imgcontheight.'px;width:'.$framewidth.'px;'.( $com_alt ? 'float:left;' : '' ).'overflow:visible;">';
