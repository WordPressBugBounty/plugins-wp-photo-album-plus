...
global $wppa_revno;
	...
	<div class="wrap">
		...
		'<h3>' . sprintf( __( 'You will find all information and examples on the new %s site', 'wp-photo-album-plus' ), '<a href="https://wppa.nl/" target="_blank" >' . __( 'Docs & Demos', 'wp-photo-album-plus' ) . '</a>' ) .  '</h3>
